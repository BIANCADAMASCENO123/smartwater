...
-- O PostgreSQL cria automaticamente se houver trigger, mas como não há, inserimos manualmente para bater com as chaves estrangeiras:
...
-- Simulando medições de hora em hora em um dia
...
-- Simulando um pico que pode gerar alerta de consumo excessivo no Bloco A
(1, 310.25, NOW() - INTERVAL '2 hours'),
(2, 195.00, NOW() - INTERVAL '2 hours'), -- Pico de consumo aqui
